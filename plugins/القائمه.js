...
*▫️🪙𝐶𝛩𝐼𝑁𝑺:* ${money}
*▫️🔱⏳𝑺𝑌𝑀𝐵𝛩𝐿𝑺:* ${joincount}
*▫️🎟️👑𝑃𝑅𝐸𝑀𝐼𝑈𝑀:* ${user.premiumTime > 0 ? '✅' : (isPrems ? '✅' : '❌') || ''}
*▫️🔱𝑁𝐴𝑀𝐸 𝐵𝛩𝑇:𝑉𝐸𝑁𝛩𝑀 𝐵𝛩𝑇🕷️🕸️*
*▫️ 👨🏻‍💻حــــط قبـــل كـــل امـــر*  (.)*
*▫️ ⛏️👨🏻‍💻𝐷𝐸𝑉𝐸𝐿𝛩𝑃𝐸𝑅𝑺 𝑁𝐴𝑀𝐸𝑺: 𝑀𝛩𝐴𝐴𝑍&𝐵𝛩𝑺𝑺 👑✨*
*▫️𝐻𝐸𝑅𝐸'𝑺 𝑇𝐻𝐸 𝐿𝐼𝑺𝑇, 𝑀𝑌 𝐷𝐸𝐴𝑅🕷️🕸️*  ${taguser}
